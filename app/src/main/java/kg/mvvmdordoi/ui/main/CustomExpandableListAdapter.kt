...
class CustomExpandableListAdapter internal constructor(
    ...
    private val titleList: List<Category>,
    private val dataList: HashMap<String, List<Category>>
    ...
    override fun getGroupView(
        ...
        Log.e(
            "saasasas12345",
            listPosition.toString() + " " + listTitle.res.toString() + " " + listTitle.image.toString()
        )
