...
class InfoMainRvAdapter(val context: Context) : RecyclerView.Adapter<InfoMainRvAdapter.AdvertViewHolder>() {
    ...
    inner class AdvertViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        fun bind(item: Info) = with(itemView) {
            ...
            name.setOnClickListener {
                val intent = Intent(App.activity, OrtListActivity::class.java)
